...
export let WaterShader = {
    ...
    fragmentShader: `
        ...
        const vec3 SEA_BASE = vec3(0.15, 0.02, 0.02);       // Dark red base
        const vec3 SEA_WATER_COLOR = vec3(0.5, 0.05, 0.05);  // Blood red water color
        ...
        vec3 getSkyColor(vec3 e) {
            e.y = max(e.y, 0.0);
            vec3 ret;
            ret.x = pow(1.0 - e.y, 2.0) * 0.2;  // Darker red sky
            ret.y = (1.0 - e.y) * 0.05;
            ret.z = 0.05 + (1.0 - e.y) * 0.1;
            return ret;
        }
